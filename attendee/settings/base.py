...
# How far in the past a scheduled bot's join_at can be and still get launched.
SCHEDULED_BOT_PAST_JOIN_AT_TOLERANCE_SECONDS = int(os.getenv("SCHEDULED_BOT_PAST_JOIN_AT_TOLERANCE_SECONDS", 300))
