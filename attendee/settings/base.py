...
PER_PARTICIPANT_VIDEO_FRAME_WIDTH = int(os.getenv("PER_PARTICIPANT_VIDEO_FRAME_WIDTH", 640))
PER_PARTICIPANT_VIDEO_FRAME_HEIGHT = int(os.getenv("PER_PARTICIPANT_VIDEO_FRAME_HEIGHT", 360))
PER_PARTICIPANT_VIDEO_FRAME_JPEG_QUALITY = int(os.getenv("PER_PARTICIPANT_VIDEO_FRAME_JPEG_QUALITY", 70))
