...
from bots.models import Bot, BotLogin
...
def get_bot_login_for_google_meet_sign_in_session(session_id):
    ...
    google_meet_bot_login = BotLogin.objects.filter(object_id=google_meet_bot_login_object_id, group__project=bot.project).first()
