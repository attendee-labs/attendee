    ...
    "properties": {
        ...
        "assembly_ai": {
            ...
            "properties": {
                ...
                "speech_model": {"type": "string", "enum": ["best", "nano", "slam-1", "universal", "universal-3-pro"], "description": "The speech model to use for transcription. See AssemblyAI docs for details."},
