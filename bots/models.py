...
class BotEventSubTypes(models.IntegerChoices):
    ...
    LEAVE_REQUESTED_AUTO_LEAVE_ONLY_BOTS_IN_MEETING = 28, "Leave requested - Auto leave only bots in meeting"
    ...
    def sub_type_to_api_code(cls, value):
        ...
        mapping = {
            ...
            cls.LEAVE_REQUESTED_AUTO_LEAVE_ONLY_BOTS_IN_MEETING: "auto_leave_only_bots_in_meeting",
        }
        return mapping.get(value)
