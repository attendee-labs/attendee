...
class BotDetailView(APIView):
    ...
    @extend_schema(
        ...
        description="Updates a bot. join_at, meeting_url, bot_name and bot_image can only be updated when the bot is  in the scheduled state. metadata can be updated at any time.",
