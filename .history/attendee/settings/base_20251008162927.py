...
# Recording storage backend configuration
RECORDING_STORAGE_BACKEND = os.getenv("RECORDING_STORAGE_BACKEND", "S3")  # Can be 'S3' or 'SWIFT'
...
SWIFT_CONTAINER_NAME = os.getenv("SWIFT_CONTAINER_NAME", "recordings")
